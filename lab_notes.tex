...
for i in range(2,10): \\
\hspace*{5mm} KMeans\_algo=KMeans(featuresCol='standardized', k=i) \\
\hspace*{5mm} KMeans\_fit=KMeans\_algo.fit(data\_scale\_output) \\
\hspace*{5mm} output=KMeans\_fit.transform(data\_scale\_output) \\
\hspace*{5mm} score=evaluator.evaluate(output) \\
\hspace*{5mm} silhouette\_score.append(score) \\
\hspace*{5mm} print("Silhouette Score:",score) \\
}
