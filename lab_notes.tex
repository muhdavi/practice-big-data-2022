...
\midrule
8 & Muhammad Munawir		& SMK N 1 Lhoksukon		& Karing Meurah Mulia \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
\newday{24 November 2022 menggantikan 29 September 2022}
...
\begin{enumerate}
\item Install Git \\
Pertema download program Git melalui link ini \url{https://git-scm.com/download/win}. Jika sudah selesai didownload langsung diinstall seperti program windows pada umumnya (Next, Next, Next, terus sampai selesai).
...
Ganti {\tt email@akun.github} dengan email yang sesuai ketika membuat akun GitHub. Selanjut jika muncul beberapa pertanyaan seperti berikut ini tekan {\tt Enter}.
\end{enumerate}
