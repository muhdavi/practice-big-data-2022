...
silhouette_scores=[]
evaluator = ClusteringEvaluator(featuresCol='iris_features',metricName='silhouette', distanceMeasure='squareEuclidean')
for K in range(2,11):
...
pca_transform = pca_model.transfrom(assembled_data)
