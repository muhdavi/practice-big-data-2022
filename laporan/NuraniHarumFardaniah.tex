...
\begin{figure}[!ht]
\includegraphics[width=\textwidth]{NuraniHarumFardaniah/hasiltabel}
\caption{Hasil tabel}
\label{gam:hasil tabel}
\end{figure}
\newpage
\begin{figure}[!ht]
\includegraphics[width=\textwidth]{NuraniHarumFardaniah/grafik1}
\caption{Hasil grafik pertama}
\label{gam:grafik1}
\end{figure}

\begin{figure}[!ht]
\includegraphics[width=\textwidth]{NuraniHarumFardaniah/grafik2}
